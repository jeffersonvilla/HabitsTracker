...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            sendErrorResponse(response, HttpStatus.UNAUTHORIZED.value(), JWT_TOKEN_EXPIRED);
        } catch (SignatureException | MalformedJwtException | IllegalArgumentException e) {
            sendErrorResponse(response, HttpStatus.UNAUTHORIZED.value(), JWT_TOKEN_NOT_VALID);
        }
    }
    ...
    private void sendErrorResponse(HttpServletResponse response, int status, String message) throws IOException {
        ...
        response.getWriter().write(
                new ObjectMapper().writeValueAsString(new ErrorResponse(HttpStatus.UNAUTHORIZED.toString(), message)));
